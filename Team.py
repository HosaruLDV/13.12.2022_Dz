class TeamIterator:
    def __init__(self, team):
        self.jun = team._juniorMembers
        self.sen = team._seniorMembers
        self.i = -1
        self.j = -1

    def __next__(self):
        if self.i < len(self.jun) - 1:
            self.i += 1
            return self.jun[self.i], 'Junior'
        elif self.j < len(self.sen) - 1:
            self.j += 1
            return self.sen[self.j], 'Senior'
        else:
            raise StopIteration
